...
public class WorldShader extends Shader
{
	...
	private static final WorldShader instance = new WorldShader();
	
	public static WorldShader getInstance()
	{
		return instance;
	}
	...
	private WorldShader()
	{
		super("worldVertex.vs", "worldFragment.fs", "worldVertexBasic.vs", "worldFragmentBasic.fs");
	...
	{
		WorldShader.ambientLight = ambientLight;
	}
	
	public static void setDirectionalLight(DirectionalLight directionalLight)
	{
		WorldShader.directionalLight = directionalLight;
	}
	...
	public static void setPointLight(PointLight[] pointLights)
	{
		...
		WorldShader.pointLights = pointLights;
	}
	...
	public static void setSpotLights(SpotLight[] spotLights)
	{
		...
		WorldShader.spotLights = spotLights;
	}
