...
public class LongarmxShader extends Shader
{
	private static final int MAX_POINT_LIGHTS = 4;
	private static final int MAX_SPOT_LIGHTS = 4;
	
	private static final LongarmxShader instance = new LongarmxShader();
	
	public static LongarmxShader getInstance()
	{
		return instance;
	}
	...
	private LongarmxShader()
	{
		super();
		
		addVertexShaderFromFile("longarmxVertex.vs");
		addFragmentShaderFromFile("longarmxFragment.fs");
		compileShader();
	...
	{
		LongarmxShader.ambientLight = ambientLight;
	}
	
	public static void setDirectionalLight(DirectionalLight directionalLight)
	{
		LongarmxShader.directionalLight = directionalLight;
	}
	...
	public static void setPointLight(PointLight[] pointLights)
	{
		...
		LongarmxShader.pointLights = pointLights;
	}
	...
	public static void setSpotLights(SpotLight[] spotLights)
	{
		...
		LongarmxShader.spotLights = spotLights;
	}
